...
<body onload="loadNumber()" background="../image/timg.jpg">
...
<table id="table" style="width: 80%;height: 450px;border: 0;background-image: url(../image/timg.jpg)" align="center">
    <tr id="class1">
        <!--几等奖，动态-->
...
<script>
    ...
    var list = [[99, 99], [12, 13], [51, 73], [1, 4], [1, 1], [2, 2]];  // 参与抽奖的桌号和座位号
